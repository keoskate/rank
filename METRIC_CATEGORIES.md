...
const STATIC_METRICS = [
  'yearHigh', 'yearLow', 'discount', // 52W data
  'peRatio', 'roe', 'priceToBook', // Quarterly
  'debtEbitda', 'netDebt', 'quickRatio', 'evEbitda',
  'freeCashFlowYield', 'ebitda', 'cash',
  'beta', 'dividend', 'marketCap'
];
