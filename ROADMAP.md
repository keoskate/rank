...
| trend breadth-23 (C7 first pass: +GLD/SLV/TLT/IEF/DBC) | FAILED:multipleTesting | 4/5 | Marginal: OOS 0.85 vs base 0.82, in-sample slightly worse. Naive breadth fails because raw 12-1 momentum ranking is vol-biased — low-vol diversifiers never crack the top-5. Next C7 hypothesis: vol-adjusted momentum ranking (deliberate new trial). |
