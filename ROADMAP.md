...
| volume-profile events (VP1 value-area / VP2 naked-POC) | PENDING | — | Pre-registered (4 trials); waiting on the one-time 2018+ minute-bar prefetch, then `node scripts/backtests/validate-volume-profile-events.js`. Prior LOW — practitioner lore, measured honestly. |
